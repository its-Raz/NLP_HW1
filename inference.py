...
def memm_viterbi(sentence, pre_trained_weights, feature2id):
    ...
    """
    print('here')
    sentence = ['*','*','The', 'successes', 'achieved', 'at', 'Federal', 'Express', ',', 'Union', 'Carbide', 'and', 'Grumman',
                'suggest', 'that', 'managing', 'speed', 'may', 'be', 'an', 'underutilized', 'source', 'of', 'competitive', 'advantage', '.','~']
    beam_threshold = 2
